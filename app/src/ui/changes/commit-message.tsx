    ...
    return (
      ...
      <h3> Revision Message </h3>
        ...
        <div style={{display: 'flex', justifyContent: 'space-between'}}>
          <div style={{ width: 'calc(50% - 20px)', marginRight: 10, position: 'absolute', right: 0, top: 10, zIndex: 10}}>
            <Button
              type="submit"
            ...
            >
              ...
              <span title={`Get Latest Revisions`} style={{textAlign: 'left', marginLeft: 8, marginRight: 8}}>
                ...
                } Getting latest revisions...</span> : (this.props.anyFilesSelected ? <span style={{textAlign: 'center'}}><div>Get Latest Revisions</div><div style={{fontSize: 11, opacity: 0.8}}>Your current changes will be saved as a revision</div></span> : 'Get Latest Revisions')}
              </span>
            </Button>
          </div>
          <div style={{ width: '100%'}}>
